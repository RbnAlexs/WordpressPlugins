...
/*
Copyright 2012-2014  Chris Mavricos, SevenSpark http://sevenspark.com
*/
...
function ubermenu_sticky_admin_notice() {
    ?><div class="error">
        <p><?php _e( '<strong>UberMenu Sticky</strong> is an Extension and requires the UberMenu plugin to function.  Please install and activate <a href="http://wpmegamenu.com">UberMenu</a> to use this extension.', 'ubermenu' ); ?></p>
    </div><?php
}
