...
function ubermenu_sticky_load_assets(){
	...
	if( UM_STICKY()->sticky_apply() ){
		...
		if( SCRIPT_DEBUG ){
			wp_enqueue_script( 'ubermenu-sticky-js' , UM_STICKY_PLUGIN_URL.'assets/ubermenu.sticky.js', array( 'jquery' , 'ubermenu' ), null, true );
		}
		else{
			wp_enqueue_script( 'ubermenu-sticky-js' , UM_STICKY_PLUGIN_URL.'assets/ubermenu.sticky.min.js', array( 'jquery' , 'ubermenu' ), null, true );
		}
...
function ubermenu_sticky_custom_styles( $styles ){
	...
	if( UM_STICKY()->sticky_apply() ){
		...
		$css.= ".ubermenu.ubermenu-sticky{ z-index:1000; }";
...
@media screen and (min-width:783px){
  * html body { margin-top: 0 !important; }
  ...
  #wpadminbar .quicklinks .ab-sub-wrapper ul .ab-sub-wrapper { bottom: -7px; } }\n";
			...
			$css.= "@media screen and (min-width:600px) and (max-width:782px){ .admin-bar .ubermenu.ubermenu-sticky, .admin-bar .ubermenu-responsive-toggle.ubermenu-sticky{ margin-top:46px; } }\n";
		}
