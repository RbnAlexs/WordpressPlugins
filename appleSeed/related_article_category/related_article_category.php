...
Description: Muestra la composición de las notas recientes y las relaciona por medio de la categoria del articulo 
Author: M2i Techteam
Author URI: http://metrics2index.com/
Version: 1.0
Text Domain: Related-Article-Category
*/
// Creating the widget 
  ...
  <div class="row"> 
   ...
   <div class="col-xs-6 .col-sm-12 .col-md-12">
       <div class="imagen_categoria">
        ...
        <img src="<?php bloginfo('template_directory'); ?>/images/fallback_image.jpg"/>
        <?php } ?>
        </a>
       </div> 
  </div>
   ...
   <?php }else { } ?>
     ...
     <span class="date_categoria"><?php echo 'Publicado hace '. human_time_diff(get_the_time('U'), current_time('timestamp')); ?></span>
     <?php } else {  } ?>
