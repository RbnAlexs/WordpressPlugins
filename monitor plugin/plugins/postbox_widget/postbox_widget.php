...
$category_id = apply_filters( 'widget_author_image', $instance['author_image'] );
$category_link = apply_filters( 'widget_author_image', $instance['author_image'] );
...
<div class="<?php echo ($cadena); ?>">
    ...
    <?php $category = get_the_category(); echo $category[0]->cat_name; $main_title = $category[0]->cat_name; $cat_id =  $category[0]->term_id; ?>
    </a>  
    </div>
     <?php } else {} ?> 
...
if ( isset( $instance[ 'caterogy_link' ] ) ) {
$category_link = $instance[ 'caterogy_link' ];
}
else {
}
...
$instance['category_link'] = ( ! empty( $new_instance['category_link'] ) ) ? strip_tags( $new_instance['category_link'] ) : '';
